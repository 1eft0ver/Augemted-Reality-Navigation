...
public class AniDownload : MonoBehaviour {
	public void DownloadAnimation() {
		...
		MonoBehaviour DownloadScroll = GameObject.Find("MenuMapTitleAnchor").GetComponent("ScrollDownload") as MonoBehaviour;
		...
		//呼叫ItemView
		MonoBehaviour ItemScroll = GameObject.Find("ItemViewAnchor").GetComponent("DownloadViewScroll") as MonoBehaviour;
