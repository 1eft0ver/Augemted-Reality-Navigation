...
public class AniSelect : MonoBehaviour {
	public void SelectAnimation() {
		...
		//放置當前選擇到Title
		MonoBehaviour SelectScroll = GameObject.Find("MenuMapTitleAnchor").GetComponent("ScrollSelect") as MonoBehaviour;
		SelectScroll.enabled = true;
		MonoBehaviour DownloadScroll = GameObject.Find("MenuMapBotAnchor").GetComponent("ScrollDownload") as MonoBehaviour;
		DownloadScroll.enabled = true;
		MonoBehaviour DeleteScroll = GameObject.Find("MenuMapBotAnchor").GetComponent("ScrollDelete") as MonoBehaviour;
		DeleteScroll.enabled = true;

		//呼叫ItemView
		MonoBehaviour ItemScroll = GameObject.Find("ItemViewAnchor").GetComponent("SelectViewScroll") as MonoBehaviour;
		ItemScroll.enabled = true;
		ItemScroll = GameObject.Find("ItemViewAnchor").GetComponent("DeleteViewScroll") as MonoBehaviour;
