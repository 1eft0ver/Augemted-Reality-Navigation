...
public class ButtonNavi : MonoBehaviour {
	public void naviAnimation() {

		UIControl.uiStatus = 3;
		//箭頭按鈕互換
		...
		//放置當前選擇到Title
		MonoBehaviour TitleScroll = GameObject.Find("TitleAnchor").GetComponent("ScrollNavi") as MonoBehaviour;
		TitleScroll.enabled = true;

		MonoBehaviour MapScroll = GameObject.Find("BotAnchor").GetComponent("ScrollMap") as MonoBehaviour;
		...
		//召喚Menu
		GameObject.Find("MenuAnchorNavi").GetComponent<ScrollRect>().enabled = false;
		MonoBehaviour CallMenu = GameObject.Find("LeftMenu").GetComponent("MenuNavi") as MonoBehaviour;
